...
const exploreLinks: { title: string; href: string; description: string }[] = [
  {
    ...
    href: "/rates&bookings",
    description: "View seasonal pricing and check real-time availability.",
  },
  {
    title: "Equipment Store",
    href: "/store",
    description: "The official store for cabin-grade gear and toys.",
  },
  {
    title: "Membership",
    href: "/membership",
    description: "Join the collective for priority access and member rates.",
  },
  {
    title: "Contact Support",
    href: "/support",
    description: "Direct concierge support for your upcoming stay.",
  },
];
      ...
      <div className="hidden md:flex items-center">
        <NavigationMenu>
          <NavigationMenuList className="gap-1 uppercase text-[11px] tracking-widest font-bold">
                  ...
                  <li className="row-span-3">
                    <NavigationMenuLink asChild>
                      ...
                      >
                        ...
                        <p className="text-sm leading-tight text-gray-400 font-normal normal-case">
                          Voted UK&apos;s best minimalist escape 2024.
                        </p>
                      </a>
                    </NavigationMenuLink>
            ...
            {/* 3. Explore Dropdown (Additional Mobile Links) */}
            <NavigationMenuItem>
              <NavigationMenuTrigger className="bg-transparent hover:bg-gray-50 uppercase tracking-widest text-gray-500 font-bold">
                Explore
              </NavigationMenuTrigger>
    ...
    <li>
      <NavigationMenuLink asChild>
        <a
          ...
          {...props}
        >
          <div className="text-[11px] font-black leading-none uppercase tracking-widest">
            {title}
          </div>
          <p className="line-clamp-2 text-xs leading-snug text-gray-500 font-normal lowercase first-letter:uppercase">
            {children}
          </p>
        </a>
      </NavigationMenuLink>
